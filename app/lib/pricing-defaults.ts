...
const MATERIAL_ALIASES: Record<string, MaterialKey> = {
  stickervinile: "vinile",
  vinileclassico: "vinile",
  stickertrasparente: "trasparente",
  stickerviniletrasparenti: "trasparente",
  stickerolografico: "olografico",
  stickerolografici: "olografico",
  stickerprespaziato: "prespaziato",
  stickerprespaziati: "prespaziato",
  stickermagnetico: "magnetico",
  stickermagnetici: "magnetico",
  supportomagnetico: "magnetico",
  stickerdtf: "dtf",
  stickertermoadesivi: "dtf",
  stickeroro: "oro",
  stickerstampataglio: "stampataglio",
  stickermezzotaglio: "mezzotaglio",
  stickeretichette: "etichette",
  stickermaxi: "maxi",
  stickerparete: "parete",
  stickercalpestabile: "calpestabile",
};
